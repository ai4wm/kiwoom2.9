...
public:
	...
	CString			GetConvertSymbolCode(CString strOrg, int nOption = 0);// 0:기존 종목코드(039490) , 1:거래소별 코드(039490_AL)
	int				FindCodeRowIndex(CString	strCode);
// 구현입니다.
protected:
	HICON m_hIcon;
	CComboBox			m_cbExchan;
	// 생성된 메시지 맵 함수
